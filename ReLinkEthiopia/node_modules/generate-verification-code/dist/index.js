...
function generateVerificationCode({ length = 6, type = 'number', } = defaultOptions) {
    if (!length)
        throw new TypeError('Length must be a defined');
    ...
    if (type === 'number' && length > MAX_LENGTH_FOR_NUMBER) {
        throw new TypeError('Length must be less than or equal 17 digits for number type');
    }
...
function getRandomIndex(type, isFirstDigit) {
